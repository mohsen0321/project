...
const testimonials = [
  { name: "Sarah Lee", role: "Professional, Sunny Ridge Hospital", text: '"AINOis tools make our patient analytics easier to manage. The platform is automated insights let us act faster, improving health outcomes for every patient we work with."', image: Avatar08, rating: 4 },
  { name: "Alice Johnson", role: "Freelancer, Bright Ideas", text: '"My freelance work has sped up thanks to AINO is powerful features. They keep my AI projects neat, offering tools that save hours of work, letting me take on more jobs."', image: Avatar07, rating: 5 },
  { name: "John Smith", role: "Professor, University of Cambridge", text: '"With AINO, my students build AI models faster, giving them a huge boost. It is helped them learn in real-time, without dealing with complex setup or install issues."', image: Avatar06, rating: 3 },
